    ...
    try:
        ...
        if args.graph:
            ...
            if contigs:
                ...
                set_labels_font_size()
                plt.hist(contigs, color='green', bins=list(range(0, 2000, 10)), align='left', rwidth=0.5)
                plt.ylabel("strains #")
                plt.xlabel("contigs #")
                plt.title("strains to contigs histogram")
                plt.xticks(list(range(0, 2000, 10)))
            ...
            if pseudogenes:
                ...
                set_labels_font_size()
                plt.hist(pseudogenes, color='green', bins=list(range(0, 2000, 10)), align='left', rwidth=0.5)
                plt.ylabel("strains #")
